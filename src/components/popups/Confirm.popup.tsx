    ...
    >
      ...
      >
        ...
        <div className="flex w-full items-center justify-center gap-5">
          <button
            className="min-w-22.5 bg-black/50 px-4 py-1 text-center text-sm text-white transition-all duration-150 hover:bg-black/20 disabled:pointer-events-none disabled:opacity-50"
            type="button"
          ...
          <button
            className="min-w-22.5 bg-red-400/50 px-4 py-1 text-center text-sm text-red-500 transition-all duration-150 hover:bg-red-400/20 disabled:pointer-events-none disabled:opacity-50"
            type="button"
